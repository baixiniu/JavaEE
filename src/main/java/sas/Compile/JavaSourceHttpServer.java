...
public class JavaSourceHttpServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HTML_WELCOME = loadHtml("com/ding/javarun/welcome.html"); // welcome HTML page, your can input your java source code here
        HTML_EXECUTOR = loadHtml("com/ding/javarun/result.html"); // here show you the online java source execute result.
    ...
    private static StringBuilder loadHtml(String html) throws IOException {
        ...
        if (!htmlFile.exists()) {
            htmlFile = new File("在线编译/src/" + html);
        }
        if (!htmlFile.exists()) {
            htmlFile = new File("在线编译/src/" + html);
        }
    ...
    private static Map<String, String> convertStream2Params(HttpExchange exchange) throws IOException {
        ...
        Map<String, String> paramMap = new HashMap<>(paramEntries.length);
